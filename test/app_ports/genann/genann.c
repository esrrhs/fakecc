...
double genann_act_sigmoid(const struct genann *ann, double a);
double genann_act_sigmoid_cached(const struct genann *ann, double a);
double genann_act_threshold(const struct genann *ann, double a);
double genann_act_linear(const struct genann *ann, double a);
double genann_act_tanh(const struct genann *ann, double a);
double genann_act_relu(const struct genann *ann, double a);
