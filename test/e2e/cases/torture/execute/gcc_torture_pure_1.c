...
void link_error0() { __builtin_abort(); }
void link_error1() { __builtin_abort(); }
void link_error2() { __builtin_abort(); }
void link_error3() { __builtin_abort(); }
void link_error4() { __builtin_abort(); }
void link_error5() { __builtin_abort(); }
void link_error6() { __builtin_abort(); }
void link_error7() { __builtin_abort(); }
