// memmove: like memcpy but handles overlapping regions.  The classic
...
// expect: 0
package main;
extern void *memmove(void *dst, void *src, unsigned long n);
int main() {
    char a[5];
    char b[5];
    char *r;
