...
{
  if (((*pos)(x, y, 1.0L, 2.0L) == 1.0L) != expected)
    abort ();
  if (((*neg)(x, y, 3.0L, 4.0L) == 4.0L) != expected)
    abort ();
}
...
main()
{
  ...
  {
    { (0.0L / 0.0L), (0.0L / 0.0L), { 1, 0, 0, 0, 0, 0 } },
    { 0.0L, (0.0L / 0.0L), { 1, 0, 0, 0, 0, 0 } },
    { (0.0L / 0.0L), 0.0L, { 1, 0, 0, 0, 0, 0 } },
    { 0.0L, 0.0L, { 0, 0, 1, 0, 1, 0 } },
    { 1.0L, 2.0L, { 0, 1, 1, 0, 0, 1 } },
    { 2.0L, 1.0L, { 0, 0, 0, 1, 1, 1 } },
    { (1.0L / 0.0L), 0.0L, { 0, 0, 0, 1, 1, 1 } },
    { 1.0L, (1.0L / 0.0L), { 0, 1, 1, 0, 0, 1 } },
    { (1.0L / 0.0L), (1.0L / 0.0L), { 0, 0, 1, 0, 1, 0 } },
    { 0.0L, -(1.0L / 0.0L), { 0, 0, 0, 1, 1, 1 } },
    { -(1.0L / 0.0L), 1.0L, { 0, 1, 1, 0, 0, 1 } },
    { -(1.0L / 0.0L), -(1.0L / 0.0L), { 0, 0, 1, 0, 1, 0 } },
    { (1.0L / 0.0L), -(1.0L / 0.0L), { 0, 0, 0, 1, 1, 1 } },
    { -(1.0L / 0.0L), (1.0L / 0.0L), { 0, 1, 1, 0, 0, 1 } },
  };
