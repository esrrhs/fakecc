...
static Type check_expr(Expr *e, const SymTable *st, FunTable *ft) {
    ...
    case EX_VAR: {
        ...
        if (runtime.strncmp(e->u.var.name, "__builtin_", 10) == 0 || runtime.strcmp(e->u.var.name, "alloca") == 0) {
            ...
            if (runtime.strcmp(bname, "__builtin_abort") == 0 || runtime.strcmp(bname, "__builtin_exit") == 0 || runtime.strcmp(bname, "__builtin_trap") == 0 || runtime.strcmp(bname, "__builtin_prefetch") == 0 || runtime.strcmp(bname, "__builtin_stack_restore") == 0)
                ret = type_make_void();
