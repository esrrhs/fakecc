...
/* Host-side IEEE 754 BID decimal.  Coefficient is two uint64 limbs — not
 * `unsigned __int128` — so bootstrap coloring does not depend on how gcc vs
 * fakecc lower 16-byte integer pairs. */
