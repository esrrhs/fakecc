...
static void parse_trailing_qualifiers(Parser *p, int *is_const, int *is_volatile, int *is_restrict) {
    for (;;) {
...
static Type parse_specifiers(Parser *p) {
    ...
    parse_trailing_qualifiers(p, &is_const, &is_volatile, &is_restrict);
